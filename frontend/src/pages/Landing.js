  ...
  const plans = [
    {
      ...
      price: '$0',
      period: 'forever',
      features: ['5 active deals', 'Basic analytics', 'Email support', 'Pipeline view'],
      cta: 'Get Started',
      featured: false
    },
    {
      ...
      price: '$49',
      period: '/month',
      features: ['Unlimited deals', 'AI pricing insights', 'Priority support', 'Advanced analytics', 'Revenue forecasting', 'Custom reports'],
    ...
    },
    {
      ...
      price: '$199',
      period: '/month',
      features: ['Everything in Pro', 'Custom integrations', 'Dedicated account manager', 'SLA guarantee', 'API access', 'SSO & advanced security'],
      cta: 'Contact Sales',
      featured: false
    }
  ];
