  ...
  <footer className="relative overflow-hidden border-t border-white/[0.06]" data-testid="main-footer">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 lg:gap-16 py-16 lg:py-20">
        ...
        <div className="col-span-2 md:col-span-4 lg:col-span-2">
          <a href="/" className="inline-flex items-center gap-2.5 group mb-5">
            ...
            <span className="text-xl font-bold text-white" style={{ fontFamily: 'Outfit' }}>Vector</span>
          </a>
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              <a key={s.label} href="#" className="w-9 h-9 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-zinc-500 hover:text-white hover:bg-white/[0.08] hover:border-white/[0.12] transition-all duration-300" aria-label={s.label} data-testid={`footer-social-${s.label.toLowerCase()}`}>
      ...
      <div className="border-t border-white/[0.06] py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-xs text-zinc-600">&copy; 2026 Vector. All rights reserved.</p>
