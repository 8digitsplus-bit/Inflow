...
const faqs = [
  ...
  },
  {
    ...
    a: 'Essential ($99/mo) — 2 integrations + core analytics. Pro ($149/mo) — 4 integrations, AI insights, CSV import, forecasting. Enterprise ($400/mo) — unlimited integrations, Custom API, Smart Assist AI, Competitor Intelligence. Flat pricing with unlimited team members. Yearly billing saves 30%.',
  },
  {
