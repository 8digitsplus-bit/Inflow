...
const plans = {
  monthly: [
    ...
    { name: 'Enterprise', price: '260', period: '/month', perUser: true, features: ['Everything in Pro', 'Sales Revenue', 'Revenue Intelligence', 'Custom integrations', 'API access'], cta: 'Maximise', featured: false, planId: 'enterprise_monthly' }
  ],
  yearly: [
    ...
    { name: 'Enterprise', price: '2,184', originalPrice: '3,120', period: '/year', perUser: true, features: ['Everything in Pro', 'Sales Revenue', 'Revenue Intelligence', 'Custom integrations', 'API access'], cta: 'Maximise', featured: false, planId: 'enterprise_yearly', savings: '30% off 1st year' }
  ]
};
